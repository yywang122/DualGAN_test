...
# optimizers
optimizer_G = torch.optim.RMSprop(itertools.chain(G_AB.parameters(), G_BA.parameters()), lr=opt.lrG, weight_decay=opt.decay)
optimizer_D_A = torch.optim.RMSprop(D_A.parameters(), lr=opt.lrD, weight_decay=opt.decay)
optimizer_D_B = torch.optim.RMSprop(D_B.parameters(), lr=opt.lrD, weight_decay=opt.decay)
'''
